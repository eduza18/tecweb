...
<body>
        ...
        <table class="table">
            ...
            <?php
                ...
                foreach($tupla as $key => $value){
                    ...
                    echo '<td><button onclick="modificarProducto(' . $value['id'] . ')">Modificar</button></td>'; // Botón de modificar
                    echo "</tr>";
                }
                ?>
            </tbody>
    ...
    <!-- Agrega un script para manejar la redirección -->
    <script>
        function modificarProducto(id) {
            // Redirige a formulario.php con el ID del producto
